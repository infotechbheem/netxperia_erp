...
<div class="container-fluid pt-4 px-4">
    <div class="card">
        <div class="card-header">
            <h4 class="m-0 text-center p-2">Your Completed Project</h4>
        </div>
        <div class="card-body">
            <div class="row">
                <!-- Project Card 1 -->
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card">
                        <div class="card-body ">
                            ...
                            $progressPercentage = 0; // Default to 0% for any unexpected status
                            }
                            @endphp
                            ...
                            <div>
                                <a href="#" class="btn btn-primary mt-2 view-project" data-title="{{ $project->title }}" data-project-id="{{ $project->project_id }}" data-status="{{ $project->project_status }}" data-start-date="{{ $project->start_date }}" data-end-date="{{ $project->end_date }}" data-category="{{ $project->category }}" data-completeDateTime="{{ $project->completeDateTime }}" data-progress="{{ $progressPercentage }}">
                                    View Details
                                </a>
                            </div>
                        </div>
            ...
            <div class="modal-body">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td id="modalTimeDate"></td>
                    </tr>
                    <tr>
                        <th>Progress:</th>
                        <td>
                            <div class="progress">
                                <div class="progress-bar bg-success" id="modalProgress" role="progressbar" style="width: 0%;" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">0%</div>
                            </div>
                        </td>
                    </tr>
                </table>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        viewProjectButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                const completeDateTime = this.getAttribute('data-completeDateTime');
                ...
                document.getElementById('modalTimeDate').textContent = completeDateTime;
