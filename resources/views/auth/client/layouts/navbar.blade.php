     ...
     <div class="navbar-nav align-items-center ms-auto">
         ...
         <div class="nav-item dropdown">
             <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                 ...
                 <img class="rounded-circle me-lg-2" src="data:image/jpeg;base64,{{ $client->profile_image }}" alt="Client Image" style="width: 40px; height: 40px;">
                 @else
                 <img class="rounded-circle me-lg-2" src="{{ asset('custom-asset/avatar.png') }}" alt="Client Image" style="width: 40px; height: 40px;">
                 @endif
                 <span class="d-none d-lg-inline-flex">{{ $client->name }}</span>
             </a>
             <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                 <a href="{{ route('employee.profile') }}" class="dropdown-item">My Profile</a>
                 <a href="#" class="dropdown-item">Settings</a>
                 <a href="{{ route('client.logout') }}" class="dropdown-item">Log Out</a>
             </div>
         </div>
     </div>
 </nav>
