            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('employee.dashboard') }}">Employee</a></li>
        ...
        <div class="container-fluid">
            <div class="card card-primary">
                <div class="card-header">
                    <h4 class="m-0">Project Assigned</h4>
                </div>
                <div class="card-body">
                    <div class="row">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        viewButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                xhr.open('GET', '/auth/admin/project/get-project-details/' + projectId, true);
                xhr.onreadystatechange = function() {
                    if (xhr.readyState === 4 && xhr.status === 200) {
                        ...
                        document.getElementById('modalEmpName').innerText = data.employee_name;
                        document.getElementById('modalEmpId').innerText = data.emp_id;
