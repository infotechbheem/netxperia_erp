 ...
 <nav class="navbar navbar-expand sticky-top px-4 py-0" style="background: rgba(255, 166, 0, 0.783)">
    ...
    <div class="navbar-nav align-items-center ms-auto">
        ...
        <div class="nav-item dropdown">
            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img class="rounded-circle me-lg-2" src="data:image/jpeg;base64,{{ $employee->profile_image }}" alt="" style="width: 40px; height: 40px;">
            ...
            <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                ...
                <a href="{{ route('employee.logout') }}" class="dropdown-item">Log Out</a>
            </div>
        </div>
    </div>
</nav>
