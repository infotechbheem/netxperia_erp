...
<head>
    <meta charset="utf-8">
    <title>NetXperia - Vendor Dashboard</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="" name="keywords">
    <meta content="" name="description">

    <!-- Favicon -->
    <link href="{{ asset('custom-asset/image/favicon.ico') }}" rel="icon">
...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <!-- Sidebar Start -->
        @include('auth.vendor.layouts.sidebar')
        <!-- Sidebar End -->

        <!-- Content Start -->
        <div class="content">
            <!-- Navbar Start -->
            @include('auth.vendor.layouts.navbar')
            <!-- Navbar End -->
            ...
            <!-- Footer Start -->
            @include('auth.vendor.layouts.footer')
            <!-- Footer End -->
        </div>
        <!-- Content End -->
